...
################
# TODO
# Add a get_observations(latitude, longitude, start, end) function
...
class NOAA(UTIL):
    ...
    DEFAULT_USER_AGENT = 'ericblarson125@gmail.com'
    ...
    def points_forecast(self, lat, long, hourly=False):
        ...
        # I think I need a personal login for the noaa weather and openstreetmap
    ...
    def points_observations(self, lat, lon, start=None, end=None, num_of_stations=1):
        """Get all nearest station observations by postalcode and
                country code.
        ...
        lat, lon = self.convert_degrees_to_decimal(lat, lon)
        zip, country = self._osm.get_postalcode_country_by_lan_lon(lat,lon)
        print(zip, country)

        points_res = self.points('{},{}'.format(round(lat, 4), round(lon, 4)))
